...
extension UIColor {
    ...
    static let purpleTheme = UIColor(named: "Purple Color")
    static let habitsScreenTheme = UIColor(named: "Background")
    static let navBarTheme = UIColor(named: "Navigation Bar Color")
    static let progressTheme = UIColor(named: "Progress Color")
    static let redTheme = UIColor(named: "Remove Button color")
    static let blueTheme = UIColor(named: "Blue Color")
    static let orangeTheme = UIColor(named: "Orange Color")
}
